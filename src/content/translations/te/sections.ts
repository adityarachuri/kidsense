...
export const sections_te: Readonly<Record<string, SectionTranslation>> = {
  ...
  'every-child': {
    ...
    description:
      'ప్రపంచంలో భిన్నంగా కదిలే, గ్రహించే, నేర్చుకునే, సంభాషించే, లేదా అనుభూతి చెందే పిల్లలపై పదిహేను అంశాలు — మరియు వారికి ఎలా మద్దతు ఇవ్వాలో, ఇక్కడి ప్రతి ఇతర అంశం లాంటి నిర్ధారణ-రహిత శ్రద్ధతోనే.',
    needsReview: true,
  },
};
