...
export const sections_hi: Readonly<Record<string, SectionTranslation>> = {
  ...
  'every-child': {
    ...
    shortTitle: 'हर बच्चा',
    description:
      'पंद्रह विषय उन बच्चों पर, जो दुनिया में अलग तरीके से चलते, महसूस करते, सीखते, संवाद करते, या अनुभव करते हैं — और उन्हें कैसे सहारा दें, हर दूसरे विषय जैसी ही गैर-निदान संबंधी देखभाल के साथ।',
    needsReview: true,
  },
};
