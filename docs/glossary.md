...
| **Ability lens**        | An optional panel (3–5 entries) noting how a behavior can present differently for a child with a physical, sensory, cognitive, or behavioral difference — never a diagnosis. See ADR-0004. |
